...
let selectedID = 0;
        ...
        var questionGroup1 = []
        questionGroup1[2] = {answerID:0, question: "CSS is used in?", selectedAns:null, answers:['front-end','server',"unix","windows"]}
        questionGroup1[1] = {answerID:2, question: "c# is _", selectedAns:null, answers:['created by Google','Unix only',"object-oriented","NOT object-oriented"]}
        questionGroup1[3] = {answerID:1, question: "Chrome use _ ram ?",selectedAns:null, answers:['no','a lot of',"none","0"]}
        questionGroup1[0] = {answerID:3, question: "Firefox is created by ", selectedAns:null, answers:['Microsoft','Google',"Apple","Mozilla"]}
        questionGroup1[3] = {answerID:1, question: "Safari is created by ", selectedAns:null, answers:['google','apple',"opera","Brave"]}
        questionGroup1[4] = {answerID:2, question: "SWE363 is",selectedAns:null, answers:['java course','database course',"web development course","Testing Course"]}
        var questionGroup2 = []
        questionGroup2[1] ={question: "you can manipulate dom in the front-end using? ", answerID:[1,3], selectedAns:[], answers:['PHP','JS','Asp','Jquery','Java','C++']}
        questionGroup2[2] ={question: "Which of the following are programming language", answerID:[0,2], selectedAns:[], answers:['Javascript','HTML','PHP','CSS']}
        questionGroup2[3] ={question: "PHP is used in the _ ?", answerID:[0,1], selectedAns:[], answers:['server side','back-end','browser','desktop']}
        questionGroup2[0] ={question: "Which of the following are object-oriented language", answerID:[2,3], selectedAns:[], answers:['C','COBOL','C#', 'JAVA']}
